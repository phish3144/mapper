...
describe('formatDuration', () => {
  ...
  it('fängt 0, negative und ungültige Werte ab', () => {
...
describe('formatMinutes', () => {
  ...
  it('rundet und fängt Randwerte ab', () => {
...
describe('formatTime', () => {
  ...
  it('gibt für null und ungültige Daten einen Strich aus', () => {
...
describe('formatDateShort', () => {
  ...
  it('gibt für null einen Strich aus', () => {
...
describe('formatDateTime', () => {
  it('stellt den abgekürzten Wochentag voran', () => {
...
describe('minutesToTime', () => {
  ...
  it('normalisiert über 24 h hinaus und rückwärts', () => {
  ...
  it('rundet und fängt ungültige Werte ab', () => {
...
describe('formatTimeWindows', () => {
  ...
  it('lässt nicht zusammenhängende Tage einzeln stehen', () => {
  ...
  it('übergeht Fenster mit unmöglichem Wochentag', () => {
  ...
  it('behält Fenster über Mitternacht bei', () => {
  ...
  it('übergeht Fenster ohne verwertbare Uhrzeiten', () => {
...
describe('pluralize', () => {
  it('wählt Singular nur bei genau eins', () => {
  ...
  it('verstümmelt Zahlen jenseits der Exponentialschwelle nicht', () => {
...
describe('formatRelativeTime', () => {
  ...
  it('meldet sehr kurze Abstände als gerade eben', () => {
  ...
  it('zählt Minuten, Stunden und Tage in der Vergangenheit', () => {
  ...
  it('geht bei größeren Abständen zu Wochen, Monaten und Jahren über', () => {
  ...
  it('gibt für ungültige Daten einen Strich aus', () => {
